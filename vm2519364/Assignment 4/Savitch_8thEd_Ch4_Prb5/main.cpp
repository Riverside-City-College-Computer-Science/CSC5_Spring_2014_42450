...
//Will calculate an estimate future pricing based on the calculated interest rate
//The formal parameter estInf is calculated rate of inflation
//The formal parameter today_parm is the price of an item today
