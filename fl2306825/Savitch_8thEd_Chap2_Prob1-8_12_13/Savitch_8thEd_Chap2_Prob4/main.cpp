...
int main(int argc, char** argv) {
    ...
    //Declare variable
    float prevSal, retroAct, newAn, oldMnth, newMnth, answr;

    //Input previous salary
    cout << "Hello, please enter your previous annual salary\n";
    cin >> prevSal;
    
    //Added the input for months
    cout << "Also insert the months of retroactive too\n";
    cin >> oldMnth;
    ...
    newMnth = newAn / 12;
    retroAct = ((prevSal * payInc) / 12) * oldMnth;
